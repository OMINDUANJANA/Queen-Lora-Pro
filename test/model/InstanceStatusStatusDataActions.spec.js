...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.InstanceStatusStatusDataActions();
  });
  ...
  describe('InstanceStatusStatusDataActions', function() {
    it('should create an instance of InstanceStatusStatusDataActions', function() {
      ...
      //var instance = new Node.InstanceStatusStatusDataActions();
      //expect(instance).to.be.a(Node.InstanceStatusStatusDataActions);
    });
