...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.ForwardMessageRequest();
  });
  ...
  describe('ForwardMessageRequest', function() {
    it('should create an instance of ForwardMessageRequest', function() {
      // uncomment below and update the code to test ForwardMessageRequest
      //var instance = new Node.ForwardMessageRequest();
      //expect(instance).to.be.a(Node.ForwardMessageRequest);
    });
