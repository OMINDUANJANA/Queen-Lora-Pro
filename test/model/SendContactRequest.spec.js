...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.SendContactRequest();
  });
  ...
  describe('SendContactRequest', function() {
    it('should create an instance of SendContactRequest', function() {
      // uncomment below and update the code to test SendContactRequest
      //var instance = new Node.SendContactRequest();
      //expect(instance).to.be.a(Node.SendContactRequest);
    });
