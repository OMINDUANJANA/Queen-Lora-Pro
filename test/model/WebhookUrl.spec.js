...
(function(root, factory) {
  ...
  describe('WebhookUrl', function() {
    it('should create an instance of WebhookUrl', function() {
      // uncomment below and update the code to test WebhookUrl
      //var instance = new Node.WebhookUrl();
      //expect(instance).to.be.a(Node.WebhookUrl);
    });
