...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.InlineResponse2005Update();
  });
  ...
  describe('InlineResponse2005Update', function() {
    it('should create an instance of InlineResponse2005Update', function() {
      // uncomment below and update the code to test InlineResponse2005Update
      //var instance = new Node.InlineResponse2005Update();
      //expect(instance).to.be.a(Node.InlineResponse2005Update);
    });
