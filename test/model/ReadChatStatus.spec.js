...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.ReadChatStatus();
  });
  ...
  describe('ReadChatStatus', function() {
    it('should create an instance of ReadChatStatus', function() {
      // uncomment below and update the code to test ReadChatStatus
      //var instance = new Node.ReadChatStatus();
      //expect(instance).to.be.a(Node.ReadChatStatus);
    });
