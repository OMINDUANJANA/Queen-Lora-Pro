...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.SendPTTRequest();
  });
  ...
  describe('SendPTTRequest', function() {
    it('should create an instance of SendPTTRequest', function() {
      // uncomment below and update the code to test SendPTTRequest
      //var instance = new Node.SendPTTRequest();
      //expect(instance).to.be.a(Node.SendPTTRequest);
    });
