...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.CreateGroupAction();
  });
  ...
  describe('CreateGroupAction', function() {
    it('should create an instance of CreateGroupAction', function() {
      // uncomment below and update the code to test CreateGroupAction
      //var instance = new Node.CreateGroupAction();
      //expect(instance).to.be.a(Node.CreateGroupAction);
    });
    ...
    it('should have the property chatIds (base name: "chatIds")', function() {
      // uncomment below and update the code to test the property chatIds
      //var instance = new Node.CreateGroupAction();
      //expect(instance).to.be();
    });
