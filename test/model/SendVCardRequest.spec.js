...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Node.SendVCardRequest();
  });
  ...
  describe('SendVCardRequest', function() {
    it('should create an instance of SendVCardRequest', function() {
      // uncomment below and update the code to test SendVCardRequest
      //var instance = new Node.SendVCardRequest();
      //expect(instance).to.be.a(Node.SendVCardRequest);
    });
