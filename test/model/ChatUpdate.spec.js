...
(function(root, factory) {
  ...
  describe('ChatUpdate', function() {
    it('should create an instance of ChatUpdate', function() {
      // uncomment below and update the code to test ChatUpdate
      //var instance = new Node.ChatUpdate();
      //expect(instance).to.be.a(Node.ChatUpdate);
    });
