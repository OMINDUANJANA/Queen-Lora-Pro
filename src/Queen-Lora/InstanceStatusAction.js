 ...
 * @module Queen-Lora/InstanceStatusAction
 * @version 1.0.0
 */
class InstanceStatusAction {
     ...
     * @alias module:Queen-Lora/InstanceStatusAction
     */
    constructor() { 
     ...
     * @param {module:Queen-Lora/InstanceStatusAction} obj Optional instance to populate.
     * @return {module:Queen-Lora/InstanceStatusAction} The populated <code>InstanceStatusAction</code> instance.
     */
...
/**
     * Returns Method name
     * @return {module:Queen-Lora/InstanceStatusAction.ActEnum}
     */
    getAct() {
        return this.act;
    }
    ...
    /**
     * Sets Method name
     * @param {module:Queen-Lora/InstanceStatusAction.ActEnum} act Method name
     */
    setAct(act) {
        this['act'] = act;
    }
/**
     * Returns Action caption for the button
     * @return {String}
     */
    getLabel() {
        return this.label;
    ...
    /**
     * Sets Action caption for the button
     * @param {String} label Action caption for the button
     */
    setLabel(label) {
        this['label'] = label;
    }
...
/**
 * Method name
 * @member {module:Queen-Lora/InstanceStatusAction.ActEnum} act
 */
