 ...
 * @module Queen-Lora/BanTestStatus
 * @version 1.0.0
 */
class BanTestStatus {
    /**
     * Constructs a new <code>BanTestStatus</code>.
     * @alias module:Queen-Lora/BanTestStatus
     */
    constructor() { 
     ...
     * @param {module:Queen-Lora/BanTestStatus} obj Optional instance to populate.
     * @return {module:Queen-Lora/BanTestStatus} The populated <code>BanTestStatus</code> instance.
     */
...
/**
    ...
    /**
     * Sets Test regex
     * @param {String} banPhoneMask Test regex
     */
