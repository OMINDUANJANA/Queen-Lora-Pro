 ...
 * @module Queen-Lora/ReadChatAction
 * @version 1.0.0
 */
class ReadChatAction {
    /**
     * Constructs a new <code>ReadChatAction</code>.
     * @alias module:Queen-Lora/ReadChatAction
     */
    constructor() { 
     ...
     * @param {module:Queen-Lora/ReadChatAction} obj Optional instance to populate.
     * @return {module:Queen-Lora/ReadChatAction} The populated <code>ReadChatAction</code> instance.
     */
...
/**
     ...
     * @param {String} phone **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.
     */
    setPhone(phone) {
        this['phone'] = phone;
    }
