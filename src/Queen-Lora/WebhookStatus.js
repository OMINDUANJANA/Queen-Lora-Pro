 ...
 * @module Queen-Lora/WebhookStatus
 * @version 1.0.0
 */
class WebhookStatus {
    /**
     * Constructs a new <code>WebhookStatus</code>.
     * @alias module:Queen-Lora/WebhookStatus
     */
    constructor() { 
     ...
     * @param {module:Queen-Lora/WebhookStatus} obj Optional instance to populate.
     * @return {module:Queen-Lora/WebhookStatus} The populated <code>WebhookStatus</code> instance.
     */
...
/**
    ...
    /**
     * Sets creation date
     * @param {String} time creation date
     */
    setTime(time) {
        this['time'] = time;
    }
/**
     * Returns status name (\"sent\", \"not sent\", \"queued\")
     * @return {String}
     */
    getStatus() {
        return this.status;
    ...
    /**
     * Sets status name (\"sent\", \"not sent\", \"queued\")
     * @param {String} status status name (\"sent\", \"not sent\", \"queued\")
     */
    setStatus(status) {
        this['status'] = status;
    }
