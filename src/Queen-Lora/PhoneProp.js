 ...
 * @module Queen-Lora/PhoneProp
 * @version 1.0.0
 */
class PhoneProp {
    /**
     * Constructs a new <code>PhoneProp</code>.
     * @alias module:Queen-Lora/PhoneProp
     */
    constructor() { 
     ...
     * @param {module:Queen-Lora/PhoneProp} obj Optional instance to populate.
     * @return {module:Queen-Lora/PhoneProp} The populated <code>PhoneProp</code> instance.
     */
