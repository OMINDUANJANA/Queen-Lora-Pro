 ...
 * @module Queen-Lora/SendLinkRequest
 * @version 1.0.0
 */
class SendLinkRequest {
    /**
     * Constructs a new <code>SendLinkRequest</code>.
     * @alias module:Queen-Lora/SendLinkRequest
     ...
     * @param {module:Queen-Lora/SendLinkRequest} obj Optional instance to populate.
     * @return {module:Queen-Lora/SendLinkRequest} The populated <code>SendLinkRequest</code> instance.
     */
...
/**
     * Returns HTTP or HTTPS link, for example *https://wikimedia.org*
     * @return {String}
     */
    getBody() {
        return this.body;
    ...
    /**
     * Sets HTTP or HTTPS link, for example *https://wikimedia.org*
...
/**
     * Returns Base64-encoded file with mime data, for example *data:image/jpeg;base64,/9j/4AAQSkZJRgABAQ...* for link's preview
     * @return {String}
     */
    getPreviewBase64() {
    ...
    /**
     * Sets Base64-encoded file with mime data, for example *data:image/jpeg;base64,/9j/4AAQSkZJRgABAQ...* for link's preview
...
/**
     * Returns Description for send link
     * @return {String}
     */
    getDescription() {
    ...
    /**
     * Sets Description for send link
     * @param {String} description Description for send link
     */
