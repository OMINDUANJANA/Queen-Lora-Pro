 ...
 * @module Queen-Lora/SendMessageRequest
 * @version 1.0.0
 */
class SendMessageRequest {
    /**
     * Constructs a new <code>SendMessageRequest</code>.
     * @alias module:Queen-Lora/SendMessageRequest
     ...
     * @param {module:Queen-Lora/SendMessageRequest} obj Optional instance to populate.
     * @return {module:Queen-Lora/SendMessageRequest} The populated <code>SendMessageRequest</code> instance.
     */
...
/**
     * Returns Message text, UTF-8 or UTF-16 string with emoji 🍏
     * @return {String}
     */
    getBody() {
        return this.body;
    ...
    /**
     * Sets Message text, UTF-8 or UTF-16 string with emoji 🍏
