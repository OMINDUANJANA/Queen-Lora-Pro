 ...
 * @module Queen-Lora/ChatIdProp
 * @version 1.0.0
 */
class ChatIdProp {
    /**
     * Constructs a new <code>ChatIdProp</code>.
     * @alias module:Queen-Lora/ChatIdProp
     */
    constructor() { 
     ...
     * @param {module:Queen-Lora/ChatIdProp} obj Optional instance to populate.
     * @return {module:Queen-Lora/ChatIdProp} The populated <code>ChatIdProp</code> instance.
     */
